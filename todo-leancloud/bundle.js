...
var app = new _vue2.default({
  ...
  methods: {
    ...
    saveTodos: function saveTodos() {
      ...
      acl.setReadAccess(_leancloudStorage2.default.User.current(), true); //只有这个user可以读
    ...
    signUp: function signUp() {
      ...
      user.signUp().then(function (loginedUser) {
        _this2.currentUser = _this2.getCurrentUser(); //注册后将当前用户赋予currentUser
      }, function (error) {
        alert("注册失败");
      });
    },
    login: function login() {
      ...
      _leancloudStorage2.default.User.logIn(this.formData.username, this.formData.password).then(function (loginedUser) {
        _this3.currentUser = _this3.getCurrentUser(); //获取当前用户
        _this3.fetchTodos(); //获取当前用户下的todos
      }, function (error) {
        alert('登录失败');
      });
    },
